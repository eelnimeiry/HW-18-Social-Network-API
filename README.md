...
Making new acquaintances, deleting old ones, and posting thoughts and reactions.
This software doesn't have a front end interface, and each route has been tested using thunderclient or postman.
